            ...
            <div class="wrap-login100">
                <form class="login100-form validate-form" method="post" action="/register">
                    ...
                    <div class="login100-form-social flex-c-m">
                        ...
                        <a href="{{ route('login_with_facebook') }}" style="text-decoration: none; box-shadow : 0 0 10px 0.5px rgba(0,0,0,0.2)"
                            class="login100-form-social-item flex-c-m bg1 m-r-5">
                            <i class="fa fa-facebook" aria-hidden="true"></i>
                        </a>

                        <a href="{{ route('login_with_github') }}" style="text-decoration: none; box-shadow : 0 0 10px 0.5px rgba(0,0,0,0.2)"
